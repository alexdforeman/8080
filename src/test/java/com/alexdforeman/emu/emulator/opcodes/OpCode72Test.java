...
/**
 * Test the OpCode72 class.
 * @author http://github.com/alexdforeman
 */
public class OpCode72Test {

    private static final int _INITIAL_D = 0xFF;
    ...
    public final void test() throws IOException {
        ...
        IOpCode opcode = new OpCode72();
        opcode.exec(state);
        Assert.assertEquals(_FINAL_PC, state.getPc());
        int[] memory = state.getMemory();
        Assert.assertEquals(_INITIAL_D, memory[_INITIAL_M]);
    }
}
